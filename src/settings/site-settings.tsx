...
export const siteSettings = {
  ...
  logo: {
    url: '/assets/images/Group_11.svg',
    alt: 'placeholder',
    href: '/',
    width: 200,
    height: 70,
        ...
        columns: [
            ...
            columnItems: [
              {
                ...
                columnItemItems: [
                  {
                    id: 1,
                    path: '/search?q=living-room-furniture',
                    label: 'Living Room',
                  },
                  {
                    id: 2,
                    path: '/search?q=bedroom-furniture',
                    label: 'Bedroom',
                  },
                  {
                    id: 3,
                    path: '/search?q=dining-room',
                    label: 'Dining Room',
                  },
                  {
                    id: 4,
                    path: '/search?q=home-office-furniture',
                    label: 'Home Office',
                  },
                  {
                    id: 5,
                    path: '/search?q=kitchen-furniture',
                    label: 'Kitchen',
                  },
                  {
                    id: 6,
                    path: '/search?q=bathroom-furniture',
                    label: 'Bathroom',
                  },
                  {
                    id: 7,
                    path: '/search?q=hallway-furniture',
                    label: 'Hallway',
                  },
                  {
                    id: 8,
                    path: '/search?q=kids-furniture',
                    label: 'Kids',
                  },
                ],
              },
          ...
          },
          {
            ...
            columnItems: [
              {
                id: 1,
                path: '/search?q=lighting',
                label: 'Lighting',
                columnItemItems: [
                  {
                    id: 1,
                    path: '/search?q=ceiling-lights',
                    label: 'Ceiling',
                  },
                  {
                    id: 2,
                    path: '/search?q=chandeliers',
                    label: 'Chandeliers',
                  },
                  {
                    id: 3,
                    path: '/search?q=pendant-lights',
                    label: 'Pendant',
                  },
                  {
                    id: 4,
                    path: '/search?q=table-lamps',
                    label: 'Table Lamps',
                  },
                  {
                    id: 5,
                    path: '/search?q=floor-lamps',
                    label: 'Floor Lamps',
                  },
                  {
                    id: 6,
                    path: '/search?q=wall-lights',
                    label: 'Wall',
                  },
                ],
              },
